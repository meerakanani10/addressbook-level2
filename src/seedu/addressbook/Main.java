...
import seedu.addressbook.storage.StorageFile.StorageOperationReadOnlyException;
...
public class Main {
    ...
    private CommandResult executeCommand(Command command) {
        try {
            ...
            return result;
        } catch (StorageOperationReadOnlyException sore) {
            return new CommandResult(sore.getMessage());
        } catch (Exception e) {
